...
$ESPTOOL --chip esp32 merge_bin --output Bruce3_cplus1_1.bin 0x1000 .pio/build/cyd2usb/bootloader.bin 0x8000 .pio/build/cyd2usb/partitions.bin 0x10000 .pio/build/cyd2usb/firmware.bin
